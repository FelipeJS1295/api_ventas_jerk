...
def procesar_url_imagen(img_path):
    ...
    Las imágenes se sirven a través del dominio configurado en Nginx
    """
    if not img_path:
    ...
    # Construir URL final - Se sirve a través de Nginx en el dominio
    final_url = f"/imagenes/productos/{filename.strip()}"
